...
app.post('/api/scann/consume', tokenAuth_1.authenticateScannerToken, scannController.consumeQrByQrId);
app.post('/api/scann/getprod', tokenAuth_1.authenticateScannerToken, scannController.getQRData);
// MercadoPago
